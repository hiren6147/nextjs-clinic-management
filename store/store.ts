...
import type { TabState } from "./slices/tabSlice";
...
interface ClinicAppState {
  tabs: TabState;
  auth: AuthState;
}

// Load initial state from localStorage if available
const loadState = (): ClinicAppState | undefined => {
  try {
    ...
    const parsedState = JSON.parse(serializedState) as Partial<ClinicAppState>;
    ...
    if (
      ...
      return parsedState as ClinicAppState;
    }
